...
const Header = () => {
    ...
    return (
        <header className="flex flex-row items-center justify-between mt-1 md:mt-4 mb-12 md:mb-16">
            ...
            >
                <div
                    className={`absolute inset-0 flex items-center ${logoLanguage ? "translate-y-0 opacity-100" : "-translate-y-full opacity-40"
                        } transition-transform duration-500`}
                >
                    <span className="block">Leopold Maitre</span>
                </div>
                <div
                    className={`absolute inset-0 flex items-center ${logoLanguage ? "translate-y-full opacity-40" : "-translate-y-0 opacity-100"
                        } transition-transform duration-500`}
                >
            ...
            <AnimatePresence>
                {Open && (
                    ...
                    >
                        <motion.ul className="flex flex-row items-start gap-4 p-4">
                            <motion.li>
