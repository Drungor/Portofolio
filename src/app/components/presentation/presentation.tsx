  ...
  return (
    <>
      <section className="text-3xl md:text-5xl">
        ...
        <p className={classNameMarginBottom}>福岡でウェブデベロッパーの仕事を探しています。</p>
        <p className={`text-li dark:text-impact ${classNameMarginBottom}`}>どうぞよろしくお願いいたします。</p>
      </section>
      <section id="SNS" className=" flex md:mb-12">
        <Button  noLeftMargin className="mr-8 ml-0 p-1 group  md:mr-12">
        ...
        <Button className=" mx-8 md:mx-12 group">
          <a
        ...
        {/* <Button className="hidden lg:block mx-8 md:mx-12">
          <a href="https://unsplash.com/@lm" target="_blank">Unsplash</a>
        </Button> */}
      </section>
